...
rule fastqc_0:
    ...
    params: 
        ...
        R1_qc = results + 'fastqc/raw/{sample}_*R1_*_fastqc.zip',
        R2_qc = results + 'fastqc/raw/{sample}_*R2_*_fastqc.zip',
        R1_html = results + 'fastqc/raw/{sample}_*R1_*_fastqc.html',
        R2_html = results + 'fastqc/raw/{sample}_*R2_*_fastqc.html'
    threads: 2
