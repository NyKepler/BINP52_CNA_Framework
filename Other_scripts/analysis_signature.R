...
###### 1. CN signatures ######
# load the dataframe
CN_mat <- readRDS('Brenton/cosine_similarity/CN_sig.SSmatrix.rds')
## exclude the samples
...
### stats analysis
for (groupID in c('ArchivalVS','MaNiLaVS','ffTumor','ffTissue','ffpe','ffPlasma')) {
  print(groupID)
  sub_df <- sample_df %>% filter(Group==groupID & !is.na(enrich_CN_1))
  # ploidy
  ploidyKW <- kruskal.test(sub_df$Ploidy~sub_df$enrich_CN_1, data = sub_df) # p = 0.26
  print(ploidyKW)
  # cellularity
  cellularityKW <- kruskal.test(sub_df$Cellularity~sub_df$enrich_CN_1, data = sub_df) # p = 0.09
  print(cellularityKW)
}
...
ggsave(filename = 'Brenton/cosine_similarity/Figures/delta_val_dist.pdf', plot = CN_dist_delta_plot, dpi = 600, width = 10, height = 7, units = 'in')
...
ggsave('Brenton/cosine_similarity/Figures/CN_sig_BH_cut_1.pdf', plot = CN_enrich_plot_1, dpi = 600, width = 10, height = 7, units = 'in')
# save the info dataframe
write_xlsx(CN_info_df_cut, path = 'CN_group_cut_1.xlsx')
...
ggsave(filename = 'Brenton/cosine_similarity/Figures/exposure_plot_groups_sort.pdf', plot = CN_exposure_plot_group, dpi = 600, width = 30, height = 7, units = 'in')
### rank by BH
...
ggsave(filename = 'Brenton/cosine_similarity/Figures/exposure_plot_BH_sort.pdf', plot = CN_exposure_plot_BH, dpi = 600, width = 30, height = 7, units = 'in')
...
CN_archival_exposure <- sig_exposure(SSmatrix = CN_archival_mat,sig_type = 'CN',threshold = 0.5)
...
ggsave(filename = 'Brenton/cosine_similarity/Figures/exposure_plot_BH_AVS.pdf', plot = CN_exposure_plot_BH_AVS, dpi = 600, width = 30, height = 7, units = 'in')
...
ggsave('Brenton/cosine_similarity/Figures/VS_exposure.pdf', plot = VS_exposure_plot_BH, dpi = 600, width = 10, height = 7, units = 'in')
...
ggsave('Brenton/cosine_similarity/Figures/Benign_VS_exposure.pdf', plot = Benign_VS_plot, dpi = 600, width = 7, height = 5, units = 'in')
...
ggsave('Brenton/cosine_similarity/Figures/RRSO_VS_exposure.pdf', plot = RRSO_VS_plot, dpi = 600, width = 7, height = 5, units = 'in')
...
ggsave('Brenton/cosine_similarity/Figures/HGSC_VS_exposure.pdf', plot = HGSC_VS_plot, dpi = 600, width = 10, height = 5, units = 'in')
...
# load the dataframe
PanCan_mat <- readRDS('Pan-Cancer/cosine_similarity/PanCan_sig.SSmatrix.rds')
## exclude the samples
...
for (groupID in c('ArchivalVS','MaNiLaVS','ffTumor','ffTissue','ffpe','ffPlasma')) {
  print(groupID)
  sub_df <- sample_df %>% filter(Group==groupID & !is.na(enrich_PanCan_1))
  # ploidy
  ploidyKW <- kruskal.test(sub_df$Ploidy~sub_df$enrich_PanCan_1, data = sub_df) # p = 0.26
  print(ploidyKW)
  # cellularity
  cellularityKW <- kruskal.test(sub_df$Cellularity~sub_df$enrich_PanCan_1, data = sub_df) # p = 0.09
  print(cellularityKW)
}
...
PanCan_info_df_cut$enrich_PanCan_1 <- factor(PanCan_info_df_cut$enrich_PanCan_1, levels = paste0('CX',c(1:17))) #c('CX1','CX2','CX3','CX5','CX10','CX15','CX17')
# plot the graph
...
ggsave('Pan-Cancer/cosine_similarity/Figures/PanCan_sig_BH_cut_1.pdf', plot = PanCan_enrich_plot_1, dpi = 600, width = 10, height = 7, units = 'in')
# save the info dataframe
write_xlsx(PanCan_info_df_cut, path = 'PanCan_group_cut_1.xlsx')
...
PanCan_info_df_cut$enrich_PanCan_2 <- factor(PanCan_info_df_cut$enrich_PanCan_2, levels = paste0('CX',c(1:17))) #c('CX1','CX2','CX3','CX5','CX10','CX15','CX17')
# plot the graph
...
ggsave(filename = 'Pan-Cancer/cosine_similarity/Figures/exposure_plot_groups_sort.pdf', plot = PanCan_exposure_plot_group, dpi = 600, width = 30, height = 7, units = 'in')
### rank by BH
...
ggsave(filename = 'Pan-Cancer/cosine_similarity/Figures/exposure_plot_BH_sort.pdf', plot = PanCan_exposure_plot_BH, dpi = 600, width = 30, height = 7, units = 'in')
### details for the ArchivalVS group
...
PanCan_archival_exposure <- sig_exposure(SSmatrix = PanCan_archival_mat,sig_type = 'PanCan',threshold = 0.5)
...
ggsave(filename = 'Pan-Cancer/cosine_similarity/Figures/exposure_plot_BH_AVS.pdf', plot = PanCan_exposure_plot_BH_AVS, dpi = 600, width = 30, height = 7, units = 'in')
...
# load the dataframe
panConusig_mat <- readRDS('panConusig/cosine_similarity/panConusig.SSmatrix.rds')
## exclude the samples
...
for (BH in c('Benign','RRSO','HGSC')) {
  print(BH)
  a <- panConusig_stat[which(panConusig_stat$BH==BH),] %>% count(patient)
  print(a)
}
...
### statistics 
for (groupID in c('ArchivalVS','MaNiLaVS','ffTumor','ffTissue','Endome','ffPlasma')) {
  print(groupID)
  sub_df <- sample_df %>% filter(Group==groupID & !is.na(enrich_panConusig_1))
  # ploidy
  ploidyKW <- kruskal.test(sub_df$Ploidy~sub_df$enrich_panConusig_1, data = sub_df) # p = 0.26
  print(ploidyKW)
  # cellularity
  cellularityKW <- kruskal.test(sub_df$Cellularity~sub_df$enrich_panConusig_1, data = sub_df) # p = 0.09
  print(cellularityKW)
}
...
ggsave('panConusig/cosine_similarity/Figures/panConusig_sig_BH_cut_1.pdf', plot = panConusig_enrich_plot_1, dpi = 600, width = 10, height = 7, units = 'in')
# save the info dataframe
write_xlsx(panConusig_info_df_cut, path = 'panConusig_group_cut_1.xlsx')
...
ggsave(filename = 'panConusig/cosine_similarity/Figures/exposure_plot_groups_sort.pdf', plot = panConusig_exposure_plot_group, dpi = 600, width = 30, height = 7, units = 'in')
### rank by BH
...
ggsave(filename = 'panConusig/cosine_similarity/Figures/exposure_plot_BH_sort.pdf', plot = panConusig_exposure_plot_BH, dpi = 600, width = 30, height = 7, units = 'in')
### details for the ArchivalVS group
...
panConusig_archival_exposure <- sig_exposure(SSmatrix = panConusig_archival_mat,sig_type = 'panConusig',threshold = 0.5)
...
ggsave(filename = 'panConusig/cosine_similarity/Figures/exposure_plot_BH_AVS.pdf', plot = panConusig_exposure_plot_BH_AVS, dpi = 600, width = 30, height = 7, units = 'in')
